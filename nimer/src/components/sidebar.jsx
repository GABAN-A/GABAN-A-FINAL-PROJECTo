...
const Sidebar2 = () => {
        ...
        return (
            ...
            <div className="col-6 btt col-lg-12 col-md-12   btn btn-light p-1 m-0 "> <NavLink to="/register">
                  <img className="h-100 ar  w-100"src={require('../images/11.png')} /></NavLink></div>
            <div className="col-6 btt col-lg-12 col-md-12  btn btn-light p-1 m-0"><img className="h-100 ar  w-100"src={require('../images/112.png')} /></div>
